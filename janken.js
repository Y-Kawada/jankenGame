$(function() {
    const window_width = $("body").width()
                              - Number($("body").css('padding-left').replace('px', ''))
                              - Number($("body").css('padding-right').replace('px', ''));
